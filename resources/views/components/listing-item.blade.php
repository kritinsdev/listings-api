...
$class = 'profit-dark-green';
} else if($modelPrice - $listingPrice > 0 && $modelPrice - $listingPrice < 30) { $class='profit-light-green' ; } else if($modelPrice - $listingPrice < 0 && $modelPrice - $listingPrice> -50) {
    $class = 'profit-grey';
    } else {
    $class = 'profit-red';
    }
    ...
    <div class="cell {{$class}}" data-title="Profit">
